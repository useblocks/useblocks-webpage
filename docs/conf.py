...
try:
    release = pkg_resources.get_distribution('useblocks_webpage').version
except pkg_resources.DistributionNotFound:
    print('useblocks webpage must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "useblocks/useblocks-webpage",
...
#
# html_title = 'useblocks webpage v0.1'
...
htmlhelp_basename = 'useblocks webpagedocs'
...
latex_documents = [
    (master_doc, 'useblocks webpage.tex', 'useblocks webpage Documentation',
...
man_pages = [
    (master_doc, 'useblocks webpage', 'useblocks webpage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'useblocks webpage', 'useblocks webpage Documentation',
     author, 'useblocks webpage', 'One line description of project.',
     'Miscellaneous'),
]
